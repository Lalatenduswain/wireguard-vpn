#!/bin/bash
#
# https://github.com/Lalatenduswain/wireguard-vpn/
...
if [[ ! -e /etc/wireguard/wg0.conf ]]; then
	...
	clear
	echo 'Welcome to this WireGuard VPN Server Installation!'
	...
	# Else, we are inside a container and BoringTun needs to be used
		...
		{ wget -qO- https://github.com/Lalatenduswain/wireguard-vpn/raw/master/unknown-linux-musl.tar.gz 2>/dev/null || curl -sL https://github.com/Lalatenduswain/wireguard-vpn/raw/master/unknown-linux-musl.tar.gz ; } | tar xz -C /usr/local/sbin/ --wildcards 'boringtun-*/boringtun' --strip-components 1
...
#!/bin/bash
latest=$(wget -qO- https://raw.githubusercontent.com/Lalatenduswain/wireguard-vpn/master/latest 2>/dev/null || curl -sL https://raw.githubusercontent.com/Lalatenduswain/wireguard-vpn/master/latest 2>/dev/null)
...
if [[ "$current" != "$latest" ]]; then
	download="https://github.com/Lalatenduswain/wireguard-vpn/raw/master/unknown-linux-musl.tar.gz"
	xdir=$(mktemp -d)
